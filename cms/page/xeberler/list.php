			...
			<?PHP				
				...
				while($n_m = MYSQLI_FETCH_ASSOC($s_m)){
					...
					<tr>
						...
						<td>
							<!-- Icons -->
							<a href="?menu=topslider&tip=3&p_id=<?php echo $n_m['u_id']; ?>" title="şəkil əlavə et">
								<img src="images/silder.jpeg" alt="slider əlavə et" style="height:25px;"/>
							 </a>&nbsp;
							 
							<a href="?menu=xeberler_photo&p_id=<?PHP echo $n_m['u_id'];?>" title="şəkil əlavə et">								<img src="images/photo.jpg" alt="şəkil əlavə et" />							 </a>&nbsp;
