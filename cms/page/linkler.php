...
<ul class="shortcut-buttons-set">
	...
	<li>
		...
		<a class="shortcut-button" href="?menu=linkler&mod=add">

		<span>

			<img src="images/banner.png" width="45px" height="45px" alt="Yeni linkler" /><br />

			<?php echo $dil['Yeni_link'][$lng]; ?>
...
<div class="content-box">
	...
	<div class="content-box-header">
		...
		<h3 style="width:87%;"><?php echo $dil['Yeni_link'][$lng]; ?></h3>
	...
	<div class="content-box-content">
		...
		<?PHP
			...
			if($mod == 'add'){ include 'linkler/add.php';}

			elseif($mod == 'edit'){ include 'linkler/edit.php';}

			elseif($mod == 'delete'){ include 'linkler/delete.php';}

			else{ include 'linkler/list.php';}
