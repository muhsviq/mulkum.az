				...
				<form action="" method="POST" enctype="multipart/form-data">
					<ul class="shortcut-buttons-set">
						...
						<li>
							<div class="button_input"><input type="submit" style="cursor: pointer; width:45px; height:45px; background: #F9F9F9 url('images/remember.png'); padding:0px; border:none;" name="save" value="" /><br><br><?php echo $dil['Yadda+saxla'][$lng]; ?></div>
						</li>
				...
				<div class="content-box">
					<div class="content-box-header">
						<h3 style="width:87%;"> <?php echo $dil['Asagi Sehifeler'][$lng]; ?></h3>
						...
						<form action="" method="POST">
							...
							<!-- HEAD -->
							 ...
							 <!-- BODY -->
								<tbody>
									<?PHP
									$menu = MYSQLI_QUERY($connection,"SELECT * FROM menu WHERE (tip=2 OR tip=3 OR tip=6 OR tip=7) AND l_id=1");
