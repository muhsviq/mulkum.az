...
<ul class="shortcut-buttons-set">
	...
	<li>
		<a class="shortcut-button" href="?menu=xeberler_photo&mod=add&p_id=<?php echo $p_id; ?>">
		<span>
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<?PHP
			$mod = @$_GET['mod'];
			if($mod == 'add'){ include 'xeberler_photo/add.php';}
			elseif($mod == 'edit'){ include 'xeberler_photo/edit.php';}
			elseif($mod == 'delete'){ include 'xeberler_photo/delete.php';}
			else{ include 'xeberler_photo/list.php';}
		?>
	</div>
</div>