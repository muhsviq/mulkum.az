...
<ul class="shortcut-buttons-set">
	...
	<li>
		<a class="shortcut-button" href="?menu=category&mod=add">
		<span>
...
<div class="content-box">
	...
	<div class="content-box-content">
		...
		<div class="tab-content default-tab" id="tab1">
			<?PHP
				@$mod = $_GET['mod'];
				if($mod == 'add'){ include 'category/add.php';}
				elseif($mod == 'edit'){ include 'category/edit.php';}
				elseif($mod == 'delete'){ include 'category/delete.php';}
				elseif($mod == 'videolist'){ include 'category/video_list.php';}
				elseif($mod == 'videoadd'){ include 'category/video_add.php';}
				elseif($mod == 'videoedit'){ include 'category/video_edit.php';}
				elseif($mod == 'videodel'){ include 'category/video_delete.php';}
				else{ include 'category/list.php';}
			?>
		<div>
